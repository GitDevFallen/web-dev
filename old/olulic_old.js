// NOT TRANSPILED AND MINIFIED JS FILE
...
$(document).ready( () => {
    ...
    $("#left").on("click", () => {
        ...
        $(".firstRow .firstRowPhotos").animate({ left: "-=" + firstRowPictureLength + "" }, 400);
        firstRowCurrentPhoto.animate({ left: "+=" + firstRowLength + "" }, 400);

        if (!firstRowNextPhoto.length)
            firstRowNextPhoto = allPhotosFirstRow.first();
        ...
        $(".secondRow .secondRowPhotos").animate({ left: "-=" + secondRowPictureLength + "" }, 400);
        secondRowCurrentPhoto.animate({ left: "+=" + secondRowLength + "" }, 400);

        if (!secondRowNextPhoto.length)
            secondRowNextPhoto = allPhotosSecondRow.first();
